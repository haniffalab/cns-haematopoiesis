...
CATEGORICAL_COVARS = ['Donor_V3', '10X_Chemistry_V2']
...
sc.pp.log1p(ad_de)
sc.tl.rank_genes_groups(ad_de, groupby='leiden_res_3', method='wilcoxon')
adata.uns['DE_leiden_res_3'] = ad_de.uns['rank_genes_groups']
...
for color in ["Technology", "published_propagated_anno_harmonised_LEVEL2_V1",'published_propagated_anno_harmonised_LEVEL1_V5']:
