#!/bin/bash
# -*- coding: utf-8 -*-
# Usage: ./14_bone_atlas_lineage_wise_integration.sh /path/to/logs
...
PY="/nfs/team298/sm54/BoneAtlasProject/src/integration/14_bone_atlas_lineage_wise_integration.py"
