...
# Define constants
UNINTEGRATED_ADATA="/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/bone_haem_atlas_with_filtered_stroma_STRINGENT_DOUBLET_REMOVAL_UNINTEGRADTED.h5ad"

INTEGRATED_DIR="/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_filtered_stroma_stringent_doublet_removal/processed_adata"
OUTPUT_DIR="/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_filtered_stroma_stringent_doublet_removal/scib_output"
