...
# adata = sc.read_h5ad('/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/bone_haem_atlas_FINAL_OBJECT_V2.h5ad')
...
# Output directories
model_dir="/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_final_ft/trained_scvi_model"
umap_dir  = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_final_ft/umap_plots"
data_dir  = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_final_ft/processed_adata"
embed_dir = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_final_ft/embedding"
...
for color, fname in [
    ...
    ('Haem_Manual_Annotation_Level1_V3', f"umap_anno_nlatent{args.n_latent}_nlayers{args.n_layers}_nhidden{args.n_hidden}_nhvg{args.n_hvg}.png")
]:
