...
# Load AnnData
adata=sc.read_h5ad('/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/bone_haem_atlas_with_filtered_stroma_PERMISSIVE_DOUBLET_REMOVAL.h5ad')
...
# Output directories
model_dir = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_with_filtered_stroma_PERMISSIVE_DOUBLET_REMOVAL/trained_scvi_model"
umap_dir  = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_with_filtered_stroma_PERMISSIVE_DOUBLET_REMOVAL/umap_plots"
data_dir  ="/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_with_filtered_stroma_PERMISSIVE_DOUBLET_REMOVAL/processed_adata"
embed_dir ="/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration_with_filtered_stroma_PERMISSIVE_DOUBLET_REMOVAL/embedding"
