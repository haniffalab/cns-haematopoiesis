...
# Load AnnData
#adata = sc.read_h5ad('/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/haematopoeitic_compartment_celltypist.h5ad')
#adata = sc.read_h5ad('/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/bone_haem_filtered_with_metadata_scvi.h5ad')
adata = sc.read_h5ad('/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/bone_haem_with_annotations_without_stroma_and_low_quality.h5ad')
...
# Output directories
model_dir = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration/trained_scvi_model"
umap_dir  = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration/umap_plots"
data_dir  = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration/processed_adata"
embed_dir = "/nfs/team298/sm54/BoneAtlasProject/data/bone_haem_compartment/best_integration/embedding"
...
for color, fname in [
    ...
    ('majority_voting_Level2', f"New_umap_anno_nlatent{args.n_latent}_nlayers{args.n_layers}_nhidden{args.n_hidden}_nhvg{args.n_hvg}.png")
]:
    plt.figure(figsize=(20, 20))
    sc.pl.umap(adata_hvg, color=color, show=False,
               title=f"New_UMAP ({color}) n_latent={args.n_latent}, n_layers={args.n_layers}, n_hidden={args.n_hidden}, n_hvg={args.n_hvg}")
    plt.tight_layout()
