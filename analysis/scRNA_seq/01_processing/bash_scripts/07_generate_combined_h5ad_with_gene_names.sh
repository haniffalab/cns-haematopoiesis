...
output_file="/lustre/scratch124/cellgen/haniffa/users/sm54/data/combined_adata_bone_cross_organ_brain_for_scvi_with_gene_names.h5ad"
...
bsub -J $JOB \
  ...
  "module load cellgen/conda;
   ...
   python 07_generate_combined_h5ad_with_gene_names.py --adata1 $adata1 --adata2 $adata2 --output $output_file"
